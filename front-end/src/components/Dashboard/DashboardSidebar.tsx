...
import { FaBuilding, FaCogs, FaComments, FaBroadcastTower, FaRobot, FaSignOutAlt, FaHeart } from "react-icons/fa";
    ...
    >
      ...
      <div className={`pb-4 ${sidebarHidden ? "flex flex-col items-center" : "ml-5"}`}>
        <Link
          ...
          className={
            sidebarHidden
              ? `flex items-center justify-center w-10 h-10 mb-2 rounded-lg transition-colors text-gray-900 ${pathname === '/dashboard/settings' ? "bg-blue-100 text-blue-700 font-semibold" : "hover:bg-gray-100"}`
              : `flex items-center w-full px-3 py-2 mb-2 rounded transition-colors text-left text-gray-900 ${pathname === '/dashboard/settings' ? "bg-blue-100 text-blue-700 font-semibold" : "hover:bg-gray-100"}`
          }
        >
